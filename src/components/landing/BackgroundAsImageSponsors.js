...
const Container = styled.div`
  ...
  background-image: url("https://www.heritage.org/sites/default/files/styles/facebook_optimized/public/images/2018-08/Space%20Force%202.jpg?itok=lDG8zZqU");
`;
        ...
        <TwoColumn>
          <LeftColumn>
            ...
            <Heading>
              ...
              <SlantedBackground>
                <span tw="text-blue-700">
                  IEEE TSYP in Conjunction with the YP in Space Congress.{" "}
                </span>
              </SlantedBackground>
            </Heading>
            ...
            <PrimaryAction>
              <a
                target="_black"
                href="https://online.fliphtml5.com/lnkdk/oyow/?fbclid=IwAR1PH0-lmmuLnLdfk1woQJxLkiEtVLbx4K9ggv7h50NPQNXPrq0WM3RVMPU"
              >
                <button tw="text-blue-700">SPONSORSHIP FILE</button>
              </a>
            </PrimaryAction>
          </LeftColumn>
        </TwoColumn>
